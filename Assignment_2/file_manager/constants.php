...
// The table above has 6 columns:
// [ACTION REQUIRED] name of the column in the above table that stores file's titles
...
// [ACTION REQUIRED] name of the column in the above table that stores file's links in S3 
define('DB_FILE_S3ZIPURL_COL_NAME', 's3zipurl');

// [ACTION REQUIRED] name of the Lambda function that is used to create zipped files
define('LAMBDA_FUNC_NAME', 'CreateZip');
